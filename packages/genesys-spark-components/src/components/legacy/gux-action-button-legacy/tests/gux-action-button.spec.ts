...
const html = `
<gux-action-button-legacy lang="en" text="Primary" accent="primary">
...
describe('gux-action-button-legacy', () => {
  it('should build', async () => {
    const page = await newSpecPage({ components, html, language });

    expect(page.rootInstance).toBeInstanceOf(GuxActionButtonLegacy);
  });
  ...
  it('should not fire actionClick event if disabled', async () => {
    const disableHtml = `
    <gux-action-button-legacy lang="en" text="Primary" accent="primary" disabled>
      <gux-action-item text="test"></gux-action-item>
      <gux-action-item text="test2"></gux-action-item>
      <gux-action-item text="test3"></gux-action-item>
      <gux-list-divider></gux-list-divider>
